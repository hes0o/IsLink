              ...
              <div className="role-selector">
                <label className="role-option">
                  ...
                  <div className="role-card">
                    ...
                    <span className="role-title">Buy Services</span>
                    <span className="role-desc">Hire freelancers for your projects</span>
                  </div>
                </label>
                <label className="role-option">
                  ...
                  <div className="role-card">
                    <span className="role-icon">💼</span>
                    <span className="role-title">Sell Services</span>
                    <span className="role-desc">Offer your skills to clients</span>
                  </div>
                </label>
              </div>
            </div>
